setwd("C:/Users/xedua/OneDrive/Escritorio/MCC-I/Semester_1/Applied Mathematics/FPA")
library(TTR)
library(forecast)
library(readr)
library(ggplot2)
...
png(filename = 'Box_Test.png', width=50, height=30, units = 'cm', res = 600)
...
# the ARIMA(4,1,3) does seem to provide an adequate predictive model
